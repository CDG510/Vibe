...
var Studio = mongoose.model("Tabb")
...
module.exports = (function() {
  return {
    ...
    get_all_contacts: function(req, res){
      Studio.find({tabb_business_id: req.params.number}, function(err, employees){
        console.log(employees);
        res.json(employees);
      });
    },
    ...
    //   }
    //     	Artist.findOne({_id: req.body.admin}, function(err, business){
